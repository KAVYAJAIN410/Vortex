...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[purple] box-sizing" id="footer" style={{position:"absolute",bottom:0}}>
      <div className="flex flex-col gap-10 sm:hidden md:flex pt-10">
        <div className="flex flex-row text-white flex-grow flex-1">
          ...
          <div className="flex flex-col flex-1 justify-center items-center pl-5 pr-5 w-[50vw]">
            ...
            RoboVITics is a group of tech-enthusiasts with a common goal of learning and striving to be the best. Being the official Robotics Club of VIT Vellore, we strive to pave the way for budding roboticists to build projects and discover their interests by providing hands-on workshops, seminars, and practical sessions. We join our hands together to work on ground-breaking projects and deliver glorious teams with a plethora of experience and achievements.
            </p>
          </div>
        </div>
