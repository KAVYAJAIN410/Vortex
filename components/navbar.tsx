...
const Navbar: React.FC = () => {
  ...
  return (
    <div className={`flex w-full h-[100px]  fixed   items-center px-10 justify-between bg-opacity-100 transition-transform duration-300${
    visible ? "translate-y-0" : "-translate-y-full"
      ...
      <div className="hidden md:flex pl-4 relative items-center justify-center z-[1000]">
        {/* Box around navigation links */}
        <div className="relative align-middle w-[60vw] max-w-[600px] h-[7vh] bg-transparent border-[3px] border-gray-300 rounded-[25px] opacity-100 z-1000 bg-white">
          {/* Navigation Links */}
